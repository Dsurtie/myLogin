<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="electricity_department_users.aspx.cs" Inherits="myLogin.users" %>
...
<head id="Head1" runat="server">
    <title></title>
     <script type="text/javascript">
        history.pushState(null, null, 'electricity_department_users.aspx');
...
<body class="styleBackground">
    <form id="form1" runat="server" >
        ...
        <center>
            <div>
                  <asp:ImageButton ID="elect" runat="server" Height="83px" CssClass="grow" ImageUrl="~/image/ELEC REQ.PNG" Width="219px" OnClick="elect_Click"/>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                 <asp:ImageButton ID="respondElect" runat="server" Height="83px" CssClass="grow" ImageUrl="~/image/RESPOND TO REQ.PNG" Width="219px" OnClick="respondElect_Click"/>
            </div>
        </center>
    </form>
</body>
