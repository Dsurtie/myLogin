<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rates.aspx.cs" Inherits="myLogin.rates" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'rates.aspx');
...
<body class="styleBackground">
    <form id="form1" runat="server">
        <center>
            <asp:ImageButton ID="backArrowRatess" CssClass="btnEx" runat="server" Height="54px" ImageUrl="~/image/red arrow.png" Width="79px" OnClick="backArrowRatess_Click"/>
        ...
        <center>
            <div >
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT * FROM [tblCMS2] WHERE ([Department] = 'Rate/Amarates') AND ([ResponseStatus] = 'Open') OR ([ResponseStatus] = 'Pending')">
                </asp:SqlDataSource>
            </div>
        </center>
