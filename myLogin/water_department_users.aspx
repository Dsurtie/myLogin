<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="water_department_users.aspx.cs" Inherits="myLogin.water_department_users" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'water_department_users.aspx');
...
<body class="styleBackground">
    <form id="form1" runat="server" >
        ...
        <center>
            <div>
                  <asp:ImageButton ID="water" runat="server" Height="83px" CssClass="grow" ImageUrl="~/image/WATER REQ.PNG" Width="219px" OnClick="water_Click"/>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                 <asp:ImageButton ID="respondWater" runat="server" Height="83px" CssClass="grow" ImageUrl="~/image/RESPOND TO REQ.PNG" Width="219px" OnClick="respondWater_Click"/>
            </div>
        </center>
    </form>
</body>
