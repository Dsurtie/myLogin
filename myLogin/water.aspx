<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="water.aspx.cs" Inherits="myLogin.water" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'water.aspx');
...
<body class="styleBackground">
    <form id="form1" runat="server">
        <center>
            <asp:ImageButton ID="backArrowWaterr" CssClass="btnEx" runat="server" Height="54px" ImageUrl="~/image/red arrow.png" Width="79px" OnClick="backArrowWaterr_Click"/>
        ...
        <center>
            <div >
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT * FROM [tblCMS2] WHERE ([Department] = 'Water/Amanzi') AND ([ResponseStatus] = 'Open') OR ([ResponseStatus] = 'Pending')">
                </asp:SqlDataSource>
            </div>
        </center>
        ...
        <center>
            <div>
                <table>
                    ...
                    <tr>
                        <td>
                            <asp:TextBox ID="txtReff" runat="server"  AutoCompleteType="Disabled" AutoPostBack="True" CausesValidation="True" CssClass="styleRounded" Height="27px" Width="247px" Enabled="false"></asp:TextBox>
                        </td>
                        <td>
                         </td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtFullName" runat="server" AutoCompleteType="Disabled" CssClass="styleRounded" Enabled="false" Height="27px" Width="247px"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label31" runat="server" CssClass="styleAlign" Font-Bold="True" Font-Names="Tahoma" Font-Size="X-Large" ForeColor="#071F8B" Text="ID NUMBER"></asp:Label>
                        </td>
                        <td>
                         </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:ImageButton ID="arrow" runat="server" CssClass="btarrow" Height="64px" ImageUrl="~/image/red arrow.png" Width="80px" OnClick="arrow_Click"/>
                         </td>
                        <td>
                         </td>
                        <td>
